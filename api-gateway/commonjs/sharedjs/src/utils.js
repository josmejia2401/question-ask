...
module.exports.getTraceID = function (headers) {
...
module.exports.validateUserIdWithToken = function (event, userId) {
    const authorization = this.getAuthorization(event);
...
module.exports.sanitizeKey = function (key) {
    if (!key) {
        return "";
    }
...
module.exports.revertSanitizedKey = function (sanitizedKey) {
    if (!sanitizedKey) {
        return "";
    }
